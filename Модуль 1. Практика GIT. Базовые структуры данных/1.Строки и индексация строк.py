...
print(name[0:3])        # с помощью индексов можно вывести последовательность символов. Параметры среза отделяются [:]. Указаный как конец среза индекс[:3] не отображается
print(name[0:3:2])      # ещё можно указать шаг среза[:2]. Он указывается после конца среза[:3]
